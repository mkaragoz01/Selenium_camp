...
class TestTestwriteaddremove():
  ...
  def test_testwriteaddremove(self):
    ...
    assert self.driver.find_element(By.CSS_SELECTOR, "*[data-test=\"add-to-cart-sauce-labs-bike-light\"]").text == "Add to cart"
